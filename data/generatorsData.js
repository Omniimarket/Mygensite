// data/generatorsData.js

// This file centralizes all metadata and content mapping for your generators.
// It helps in managing generator details and content imports efficiently.

// IMPORTANT: Import all your content files here with .js extension
import businessNameContent from '../content/generators/business-name-generator.js';
import usernameContent from '../content/generators/username-generator.js';
import fantasyNameContent from '../content/generators/fantasy-name-generator.js';
import randomNameContent from '../content/generators/random-name-generator.js';
import randomWordContent from '../content/generators/random-word-generator.js';
import bookTitleContent from '../content/generators/book-title-generator.js';
import paragraphContent from '../content/generators/paragraph-generator.js';
import sloganContent from '../content/generators/slogan-generator.js';
import hashtagContent from '../content/generators/hashtag-generator.js';
import companyNameContent from '../content/generators/company-name-generator.js';
import bandNameContent from '../content/generators/band-name-generator.js';
import characterNameContent from '../content/generators/character-name-generator.js';
import rapLyricsContent from '../content/generators/rap-lyrics-generator.js';
import randomPasswordContent from '../content/generators/random-password-generator.js';
import coverLetterContent from '../content/generators/cover-letter-generator.js';
import brandNameContent from '../content/generators/brand-name-generator.js';
import teamNameContent from '../content/generators/team-name-generator.js';
import nicknameContent from '../content/generators/nickname-generator.js';
import blogPostIdeaContent from '../content/generators/blog-post-idea-generator.js';
import youtubeDescriptionContent from '../content/generators/youtube-description-generator.js';
import emailSubjectLineContent from '../content/generators/email-subject-line-generator.js';
import instagramCaptionContent from '../content/generators/instagram-caption-generator.js';
import tweetContent from '../content/generators/tweet-generator.js';
import linkedinHeadlineContent from '../content/generators/linkedin-headline-generator.js';
import businessIdeaContent from '../content/generators/business-idea-generator.js';
import productNameContent from '../content/generators/product-name-generator.js';
import songTitleContent from '../content/generators/song-title-generator.js';
import storyIdeaContent from '../content/generators/story-idea-generator.js';
import randomFactContent from '../content/generators/random-fact-generator.js';
import jokeContent from '../content/generators/joke-generator.js';
import quoteContent from '../content/generators/quote-generator.js';
import recipeContent from '../content/generators/recipe-generator.js';
import mealPlanContent from '../content/generators/meal-plan-generator.js';
import workoutPlanContent from '../content/generators/workout-plan-generator.js';
import travelItineraryContent from '../content/generators/travel-itinerary-generator.js';
import giftIdeaContent from '../content/generators/gift-idea-generator.js';
import dilemmaResolverContent from '../content/generators/dilemma-resolver.js';
import dreamInterpreterContent from '../content/generators/dream-interpreter.js';
import chatBotContent from '../content/generators/chat-bot.js';
import horoscopeContent from '../content/generators/horoscope-generator.js';
import riddleContent from '../content/generators/riddle-generator.js';
import triviaQuestionContent from '../content/generators/trivia-question-generator.js';
import wouldYouRatherContent from '../content/generators/would-you-rather-generator.js';
import truthOrDareContent from '../content/generators/truth-or-dare-generator.js';
import neverHaveIEverContent from '../content/generators/never-have-i-ever-generator.js';
import twoTruthsAndALieContent from '../content/generators/two-truths-and-a-lie-generator.js';
import madLibsContent from '../content/generators/mad-libs-generator.js';
import charadesContent from '../content/generators/charades-generator.js';
import catchphraseContent from '../content/generators/catchphrase-generator.js';
import newsHeadlineContent from '../content/generators/news-headline-generator.js';
// import plotTwistContent from '../content/generators/plot-twist-generator.js'; // Commented out in original
import dialogueContent from '../content/generators/dialogue-generator.js';
import cssGradientContent from '../content/generators/css-gradient-generator.js';
import albumNameContent from '../content/generators/album-name-generator.js';
import discordNameContent from '../content/generators/discord-name-generator.js';
import domainNameContent from '../content/generators/domain-name-generator.js';
import shopNameContent from '../content/generators/shop-name-generator.js';
import storeNameContent from '../content/generators/store-name-generator.js';
import companySloganContent from '../content/generators/company-slogan-generator.js';
import businessSloganContent from '../content/generators/business-slogan-generator.js';
import websiteNameContent from '../content/generators/website-name-generator.js';
import youtubeTitleContent from '../content/generators/youtube-title-generator.js';
import punContent from '../content/generators/pun-generator.js';
import lyricContent from '../content/generators/lyric-generator.js';
import dietPlanContent from '../content/generators/diet-plan-generator.js';
import motivationalQuoteContent from '../content/generators/motivational-quote-generator.js';
import linkedinSummaryContent from '../content/generators/linkedin-summary-generator.js';
import cafeNameContent from '../content/generators/cafe-name-generator.js';
import twitchUsernameContent from '../content/generators/twitch-username-generator.js';
import xboxGamertagContent from '../content/generators/xbox-gamertag-generator.js';
import robloxUsernameContent from '../content/generators/roblox-username-generator.js';
import fortniteNameContent from '../content/generators/fortnite-name-generator.js';
import callOfDutyNameContent from '../content/generators/call-of-duty-name-generator.js';
import pubgNameContent from '../content/generators/pubg-name-generator.js';
import powerballContent from '../content/generators/powerball-generator.js';
import megaMillionsContent from '../content/generators/mega-millions-generator.js';
import pick5Content from '../content/generators/pick-5-generator.js';
import fantasy5Content from '../content/generators/fantasy-5-generator.js';
import robloxPasswordContent from '../content/generators/roblox-password-generator.js';
import petNameContent from '../content/generators/pet-name-generator.js';
import coolNameContent from '../content/generators/cool-name-generator.js';
import funnyNameContent from '../content/generators/funny-name-generator.js';
import fakeNameContent from '../content/generators/fake-name-generator.js';
import playlistNameContent from '../content/generators/playlist-name-generator.js';
import movieTitleContent from '../content/generators/movie-title-generator.js';
import filmNameContent from '../content/generators/film-name-generator.js';
// import bandLogoContent from '../content/generators/band-logo-generator.js'; // This was in original, but no content file provided. Leaving commented.
import djNameContent from '../content/generators/dj-name-generator.js';
import artistNameContent from '../content/generators/artist-name-generator.js';
import stageNameContent from '../content/generators/stage-name-generator.js';
// import rhymeContent from '../content/generators/rhyme-generator.js'; // No content file provided. Leaving commented.
import bioContent from '../content/generators/bio-generator.js';
// import writingPromptContent from '../content/generators/writing-prompt-generator.js'; // Commented out in original
// import characterBackstoryContent from '../content/generators/character-backstory-generator.js'; // Commented out in original
// import plotContent from '../content/generators/plot-generator.js'; // Commented out in original
// import scriptContent from '../content/generators/script-generator.js'; // Commented out in original
import inspirationalQuoteContent from '../content/generators/inspirational-quote-generator.js';
import sloganMakerContent from '../content/generators/slogan-maker.js';
import taglineContent from '../content/generators/tagline-generator.js';
import instagramBioContent from '../content/generators/instagram-bio-generator.js';
import facebookPostContent from '../content/generators/facebook-post-generator.js';
import tiktokHashtagContent from '../content/generators/tiktok-hashtag-generator.js';
import metaDescriptionContent from '../content/generators/meta-description-generator.js';
import keywordContent from '../content/generators/keyword-generator.js';
import logoNameContent from '../content/generators/logo-name-generator.js';
import gameNameContent from '../content/generators/game-name-generator.js';
import guildNameContent from '../content/generators/guild-name-generator.js';
import clanNameContent from '../content/generators/clan-name-generator.js';
import superheroNameContent from '../content/generators/superhero-name-generator.js';
import dndNameContent from '../content/generators/dnd-name-generator.js';
import rapperNameContent from '../content/generators/rapper-name-generator.js';
import sciFiNameContent from '../content/generators/sci-fi-name-generator.js';
import villainNameContent from '../content/generators/villain-name-generator.js';
import rpgNameContent from '../content/generators/rpg-name-generator.js';
import animeNameContent from '../content/generators/anime-name-generator.js';
import sportsTeamNameContent from '../content/generators/sports-team-name-generator.js';
import fantasyFootballNameContent from '../content/generators/fantasy-football-name-generator.js';
import securePasswordContent from '../content/generators/secure-password-generator.js';
import randomLetterContent from '../content/generators/random-letter-generator.js';
import randomColorContent from '../content/generators/random-color-generator.js';
import randomDateContent from '../content/generators/random-date-generator.js';
import randomTimeContent from '../content/generators/random-time-generator.js';
import fakeEmailContent from '../content/generators/fake-email-generator.js';
// import htmlCodeContent from '../content/generators/html-code-generator.js'; // Commented out in original
import memeTextContent from '../content/generators/meme-text-generator.js';
import memeCaptionContent from '../content/generators/meme-caption-generator.js';
import roastContent from '../content/generators/roast-generator.js';
import comebackContent from '../content/generators/comeback-generator.js';
import cocktailNameContent from '../content/generators/cocktail-name-generator.js';
import restaurantNameContent from '../content/generators/restaurant-name-generator.js';
import appNameContent from '../content/generators/app-name-generator.js';

// This maps the generatorType from the URL to the imported content object
// It contains the description and FAQ data for each generator.
export const generatorContentMap = {
  'business-name-generator': businessNameContent,
  'restaurant-name-generator': restaurantNameContent,
  'app-name-generator': appNameContent,
  ...
  'game-name-generator': gameNameContent,
...
// This data contains core information and SEO metadata for each generator.
// It will be used for displaying generator links and generating page metadata.
export const generatorDetails = {
  'business-name-generator': {
    title: 'Business Name Generator',
    keywords: 'business name, company name, startup name, AI generator, free business name, creative business names, brand name, store name, shop name, restaurant name, cafe name, app name, logo name, product name, domain name, website name',
  ...
  'username-generator': {
    ...
    keywords: 'username, unique username, cool username, gaming username, social media username, AI username generator, twitch username, xbox gamertag, roblox username, fortnite name, call of duty name, pubg name, discord name',
  ...
  'fantasy-name-generator': {
    ...
    keywords: 'fantasy name, character name, RPG name, AI generator, magical names, mythical names, elf, dwarf, dragon, sci-fi names, dnd name, villain name, anime name, hero name',
  ...
  'random-name-generator': {
    ...
    keywords: 'random name, male name, female name, baby name, unique name, diverse names, AI name generator, cool name, funny name, fake name, pet name',
  ...
  'random-word-generator': {
    ...
    keywords: 'random word, word generator, vocabulary, writing prompt, game ideas, AI word generator, random letter, rhyme',
  ...
  'book-title-generator': {
    ...
    keywords: 'book title, novel title, story title, catchy title, AI title generator, creative writing, movie title, film name',
  ...
  'paragraph-generator': {
    ...
    keywords: 'paragraph writer, content generator, essay helper, article writing, AI text generator, bio generator, cover letter, linkedin summary',
  ...
  'slogan-generator': {
    ...
    keywords: 'slogan maker, tagline generator, marketing slogan, advertising slogan, AI slogan generator, company slogan, business slogan, slogan maker, tagline',
  ...
  'hashtag-generator': {
    ...
    keywords: 'hashtag finder, social media marketing, Instagram hashtags, Twitter trends, AI hashtag generator, tiktok hashtag',
  ...
  'company-name-generator': {
    ...
    keywords: 'company name, business name, startup name, corporate name, AI name generator, brand name, product name, logo name',
  ...
  'band-name-generator': {
    ...
    keywords: 'band name, music group names, rock band names, creative names, AI band name generator, album name, song title, dj name, artist name, stage name, rapper name',
  ...
  'character-name-generator': {
    ...
    keywords: 'character name, story character, RPG character, unique names, AI character name generator, fantasy name, dnd name, anime name, superhero name, villain name',
  ...
  'rap-lyrics-generator': {
    ...
    keywords: 'rap lyrics, hip-hop lyrics, song generator, rhyme generator, AI rap generator, lyric generator',
  ...
  'random-password-generator': {
    ...
    keywords: 'password generator, secure password, strong password, random password, password security, online safety, roblox password',
  ...
  'cover-letter-generator': {
    ...
    keywords: 'cover letter, job application, resume cover letter, cover letter writer, AI cover letter generator, bio generator, linkedin summary',
  ...
  'brand-name-generator': {
    ...
    keywords: 'brand name, product brand, company brand, memorable name, AI brand name generator, business name, company name, logo name',
  ...
  'team-name-generator': {
    ...
    keywords: 'team name, sports team, gaming group, project team, unique team names, AI team name generator, guild name, clan name, fantasy football name',
  ...
  'nickname-generator': {
    ...
    keywords: 'nickname, cool nickname, funny nickname, cute nickname, AI nickname generator, username, pet name',
  ...
  'blog-post-idea-generator': {
    ...
    keywords: 'blog ideas, content ideas, writing prompts, blog post topics, AI blog generator, story idea, news headline',
  ...
  'youtube-description-generator': {
    ...
    keywords: 'YouTube description, video SEO, YouTube creator, video marketing, AI YouTube description generator, youtube title, social media content',
  ...
  'restaurant-name-generator': {
    ...
    keywords: 'restaurant name, cafe name, eatery name, dining name, food business name, AI restaurant name generator, business name, shop name, store name',
  ...
  'app-name-generator': {
    ...
    keywords: 'app name, mobile app, application name, software name, AI app name generator, business name, product name, game name',
  ...
  'email-subject-line-generator': {
    ...
    keywords: 'email subject, email marketing, subject line, catchy email, AI email subject generator, business email, marketing content',
  ...
  'instagram-caption-generator': {
    ...
    keywords: 'Instagram caption, social media caption, photo caption, engaging caption, AI Instagram generator, instagram bio, social media content',
  ...
  'tweet-generator': {
    ...
    keywords: 'Twitter post, tweet ideas, social media content, viral tweet, AI tweet generator, facebook post',
  ...
  'linkedin-headline-generator': {
    ...
    keywords: 'LinkedIn headline, professional headline, career profile, LinkedIn optimization, AI LinkedIn generator, linkedin summary, professional bio',
  ...
  'business-idea-generator': {
    ...
    keywords: 'business ideas, startup ideas, entrepreneurship, innovation, AI business generator, product idea, new business, company idea',
  ...
  'product-name-generator': {
    ...
    keywords: 'product name, new product, marketing names, unique product names, AI product name generator, brand name, app name',
  ...
  'song-title-generator': {
    ...
    keywords: 'song title, music title, catchy song names, lyrical inspiration, AI song title generator, album name, band name, lyric generator',
  ...
  'story-idea-generator': {
    ...
    keywords: 'story ideas, plot generator, writing prompts, creative writing, AI story generator, book title, dialogue, news headline',
  ...
  'random-fact-generator': {
    ...
    keywords: 'random facts, interesting facts, fun facts, daily facts, AI fact generator, trivia question',
  ...
  'joke-generator': {
    ...
    keywords: 'joke generator, funny jokes, dad jokes, clean jokes, AI joke generator, riddle, comeback, roast',
  ...
  'recipe-generator': {
    ...
    keywords: 'recipe generator, cooking ideas, meal planner, ingredient suggestions, AI recipe generator, diet plan',
  ...
  'meal-plan-generator': {
    ...
    keywords: 'meal plan, healthy eating, diet planner, nutrition, AI meal plan generator, recipe generator, diet plan',
  ...
  'workout-plan-generator': {
    ...
    keywords: 'workout plan, fitness routine, exercise plan, gym workout, home workout, AI workout generator, diet plan',
  ...
  'dream-interpreter': {
    ...
    keywords: 'dream meaning, dream analysis, subconscious, dream symbols, AI dream interpreter, horoscope',
  ...
  'horoscope-generator': {
    ...
    keywords: 'horoscope, zodiac, astrology, daily horoscope, AI horoscope generator, dream interpreter',
  ...
  'riddle-generator': {
    ...
    keywords: 'riddle generator, brain teasers, puzzles, kids riddles, challenging riddles, AI riddle generator, joke, trivia question',
  ...
  'trivia-question-generator': {
    ...
    keywords: 'trivia questions, quiz generator, general knowledge, fun facts, AI trivia generator, riddle, random fact',
  ...
  'would-you-rather-generator': {
    ...
    keywords: 'would you rather, party game, icebreaker, fun questions, AI would you rather generator, truth or dare, never have I ever, two truths and a lie',
  ...
  'truth-or-dare-generator': {
    ...
    keywords: 'truth or dare, party game, fun challenges, dares, AI truth or dare generator, would you rather, never have I ever, two truths and a lie',
  ...
  'never-have-i-ever-generator': {
    ...
    keywords: 'never have I ever, party game, icebreaker, fun questions, AI never have I ever generator, would you rather, truth or dare, two truths and a lie',
  ...
  'two-truths-and-a-lie-generator': {
    ...
    keywords: 'two truths and a lie, party game, icebreaker, fun facts, AI two truths and a lie generator, would you rather, truth or dare, never have I ever',
  ...
  'news-headline-generator': {
    ...
    keywords: 'news headline, article title, journalistic writing, catchy headlines, AI news headline generator, blog post idea, story idea',
  ...
  'dialogue-generator': {
    ...
    keywords: 'dialogue writer, script generator, character conversation, creative writing, AI dialogue generator, story idea',
  ...
  'css-gradient-generator': {
    ...
    keywords: 'css gradient, gradient generator, web design, UI, UX, color blend, AI CSS generator, random color',
  ...
  'album-name-generator': {
    ...
    keywords: 'album name, music title, record name, band album, AI album name generator, band name, song title, playlist name',
  ...
  'discord-name-generator': {
    ...
    keywords: 'discord name, gaming name, online name, unique discord, AI discord name generator, username',
  ...
  'domain-name-generator': {
    ...
    keywords: 'domain name, website name, URL generator, brand name, AI domain name generator, business name',
  ...
  'shop-name-generator': {
    ...
    keywords: 'shop name, store name, retail name, e-commerce name, AI shop name generator, business name, restaurant name, cafe name',
  ...
  'store-name-generator': {
    ...
    keywords: 'store name, retail business, shop name, brand identity, AI store name generator, business name, restaurant name, cafe name',
  ...
  'company-slogan-generator': {
    ...
    keywords: 'company slogan, business tagline, corporate slogan, brand message, AI company slogan generator, slogan, tagline, slogan maker',
  ...
  'business-slogan-generator': {
    ...
    keywords: 'business slogan, marketing tagline, advertising motto, brand statement, AI business slogan generator, slogan, tagline, slogan maker',
  ...
  'website-name-generator': {
    ...
    keywords: 'website name, domain ideas, online platform, URL suggestions, AI website name generator, business name',
  ...
  'youtube-title-generator': {
    ...
    keywords: 'youtube title, video title, SEO title, clickbait title, AI YouTube title generator, youtube description, social media content',
    promptLabel: 'Enter video topic and keywords:',
  ...
  'pun-generator': {
    title: 'Pun Generator',
    keywords: 'pun generator, funny puns, wordplay, humor, AI pun generator, joke',
  ...
  'lyric-generator': {
    ...
    keywords: 'song lyrics, songwriting, music writing, verse generator, AI lyric generator, rap lyrics, song title',
  ...
  'diet-plan-generator': {
    ...
    keywords: 'diet plan, meal planning, healthy eating, nutrition, AI diet plan generator, recipe generator, meal plan, workout plan',
  ...
  'motivational-quote-generator': {
    ...
    keywords: 'motivational quote, inspirational words, success quotes, positive affirmations, AI motivational quote generator, quote generator, inspirational quote',
  ...
  'linkedin-summary-generator': {
    ...
    keywords: 'linkedin summary, professional profile, career summary, personal branding, AI LinkedIn summary generator, linkedin headline, bio generator, cover letter',
  ...
  'cafe-name-generator': {
    ...
    keywords: 'cafe name, coffee shop name, unique cafe, restaurant name, AI cafe name generator, business name, shop name, store name',
  ...
  'twitch-username-generator': {
    ...
    keywords: 'twitch name, streamer name, gaming username, live streaming, AI Twitch username generator, username',
  ...
  'xbox-gamertag-generator': {
    ...
    keywords: 'xbox gamertag, gaming name, gamer tag, unique gamertag, AI Xbox gamertag generator, username',
  ...
  'roblox-username-generator': {
    ...
    keywords: 'roblox name, gaming username, kids games, unique roblox, AI Roblox username generator, username',
  ...
  'fortnite-name-generator': {
    ...
    keywords: 'fortnite name, gaming name, battle royale, cool names, AI Fortnite name generator, username',
  ...
  'call-of-duty-name-generator': {
    ...
    keywords: 'call of duty name, cod name, gaming name, FPS game, AI Call of Duty name generator, username',
  ...
  'pubg-name-generator': {
    ...
    keywords: 'pubg name, playerunknown\'s battlegrounds, gaming name, battle royale, AI PUBG name generator, username',
  ...
  'powerball-generator': {
    ...
    keywords: 'powerball, lottery numbers, random numbers, lucky numbers, AI Powerball generator, mega millions, pick 5, fantasy 5',
  ...
  'mega-millions-generator': {
    ...
    keywords: 'mega millions, lottery numbers, random numbers, lucky numbers, AI Mega Millions generator, powerball, pick 5, fantasy 5',
  ...
  'pick-5-generator': {
    ...
    keywords: 'pick 5, lottery numbers, daily lottery, random numbers, AI Pick 5 generator, powerball, mega millions, fantasy 5',
  ...
  'fantasy-5-generator': {
    ...
    keywords: 'fantasy 5, lottery numbers, state lottery, random numbers, AI Fantasy 5 generator, powerball, mega millions, pick 5',
  ...
  'roblox-password-generator': {
    ...
    keywords: 'roblox password, secure password, gaming password, AI password generator, random password',
  ...
  'pet-name-generator': {
    ...
    keywords: 'pet name, dog names, cat names, unique pet names, AI pet name generator, random name, nickname',
  ...
  'cool-name-generator': {
    ...
    keywords: 'cool names, unique names, trendy names, AI name generator, random name',
  ...
  'funny-name-generator': {
    ...
    keywords: 'funny names, silly names, humorous names, AI funny name generator, random name, joke',
  ...
  'fake-name-generator': {
    ...
    keywords: 'fake names, random identity, dummy names, AI fake name generator, random name',
  ...
  'playlist-name-generator': {
    ...
    keywords: 'playlist name, music playlist, catchy names, song compilation, AI playlist name generator, album name, song title',
  ...
  'movie-title-generator': {
    ...
    keywords: 'movie title, film title, cinema names, blockbuster titles, AI movie title generator, book title, story idea',
  ...
  'film-name-generator': {
    ...
    keywords: 'film name, movie title, independent film, documentary title, AI film name generator, book title, story idea',
    promptLabel: 'Enter film genre, key concept, or keywords:',
    placeholder: 'e.g., "drama, family secrets", "thriller, psychological"',
    apiType: 'film-name'
  },
  // 'band-logo-generator': { // No content file provided.
  ...
  'dj-name-generator': {
    ...
    keywords: 'DJ name, electronic music, producer name, unique DJ, AI DJ name generator, band name, artist name, stage name',
  ...
  'artist-name-generator': {
    ...
    keywords: 'artist name, musician name, creative name, performer name, AI artist name generator, dj name, stage name, band name, rapper name',
  ...
  'stage-name-generator': {
    ...
    keywords: 'stage name, performer name, artist name, music name, AI stage name generator, dj name, rapper name, artist name',
  ...
  // 'rhyme-generator': { // No content file provided.
  //   title: 'Rhyme Generator',
  //   keywords: 'rhyme, rhyming words, poetry, lyrics, AI rhyme generator',
  //   promptLabel: 'Enter a word to find rhymes for:',
  //   placeholder: 'e.g., "cat", "moon", "true"',
  //   apiType: 'rhyme'
  // },
  'bio-generator': {
    title: 'Bio Generator',
    keywords: 'bio writer, professional bio, personal bio, social media bio, AI bio generator, linkedin summary, instagram bio, cover letter',
  ...
  'inspirational-quote-generator': {
    ...
    keywords: 'inspirational quotes, uplifting words, positive thoughts, motivation, AI quote generator, motivational quote',
  ...
  'slogan-maker': {
    title: 'Slogan Maker',
    keywords: 'slogan generator, tagline creator, marketing slogans, brand messages, AI slogan maker, slogan, tagline, company slogan, business slogan',
  ...
  'tagline-generator': {
    ...
    keywords: 'tagline creator, brand taglines, company slogans, memorable phrases, AI tagline generator, slogan, slogan maker, company slogan, business slogan',
  ...
  'instagram-bio-generator': {
    ...
    keywords: 'instagram bio, social media bio, profile bio, engaging bio, AI instagram bio generator, instagram caption, bio generator',
  ...
  'facebook-post-generator': {
    ...
    keywords: 'facebook post, social media content, engaging post, business post, AI facebook post generator, tweet, social media marketing',
  ...
  'tiktok-hashtag-generator': {
    ...
    keywords: 'tiktok hashtags, viral hashtags, fyp, tiktok SEO, AI tiktok hashtag generator, hashtag generator, social media content',
  ...
  'meta-description-generator': {
    ...
    keywords: 'meta description, SEO content, website description, search engine optimization, AI meta description generator, keyword generator, website content',
  ...
  'keyword-generator': {
    ...
    keywords: 'keyword research, SEO keywords, content marketing, search terms, AI keyword generator, meta description',
  ...
  'logo-name-generator': {
    ...
    keywords: 'logo name, brand name, visual identity, company logo, AI logo name generator, business name',
  ...
  'game-name-generator': {
    ...
    keywords: 'game name, video game title, board game name, app game, AI game name generator, guild name, clan name, rpg name',
  ...
  'guild-name-generator': {
    ...
    keywords: 'guild name, clan name, gaming community, unique guild names, AI guild name generator, game name, team name',
  ...
  'clan-name-generator': {
    ...
    keywords: 'clan name, gaming team, competitive squad, unique clan names, AI clan name generator, game name, guild name, team name',
  ...
  'superhero-name-generator': {
    ...
    keywords: 'superhero name, hero name, comic character, powers, AI superhero name generator, character name, villain name',
  ...
  'dnd-name-generator': {
    ...
    keywords: 'dnd name, dungeons and dragons, fantasy names, character names, AI D&D name generator, fantasy name, rpg name',
  ...
  'rapper-name-generator': {
    ...
    keywords: 'rapper name, hip-hop name, stage name, unique rapper, AI rapper name generator, artist name, dj name, stage name',
  ...
  'sci-fi-name-generator': {
    ...
    keywords: 'sci fi name, futuristic names, alien names, space names, AI sci-fi name generator, fantasy name, character name',
  ...
  'villain-name-generator': {
    ...
    keywords: 'villain name, antagonist name, evil names, dark names, AI villain name generator, superhero name, character name',
  ...
  'rpg-name-generator': {
    ...
    keywords: 'rpg name, role-playing game, character names, fantasy world names, AI RPG name generator, dnd name, game name',
  ...
  'anime-name-generator': {
    ...
    keywords: 'anime name, manga name, Japanese names, character names, AI anime name generator, fantasy name',
  ...
  'sports-team-name-generator': {
    ...
    keywords: 'sports team name, team names, club names, athletic names, AI sports team name generator, fantasy football name',
  ...
  'fantasy-football-name-generator': {
    ...
    keywords: 'fantasy football name, funny team name, creative league names, AI fantasy football name generator, sports team name, team name',
  ...
  'secure-password-generator': {
    ...
    keywords: 'secure password, strong password, password security, random password, AI password generator, roblox password',
  ...
  'random-letter-generator': {
    ...
    keywords: 'random letter, alphabet, letter picker, word games, AI random letter generator, random word',
  ...
  'random-color-generator': {
    ...
    keywords: 'random color, hex code, RGB, color palette, design tool, AI color generator, css gradient',
  ...
  'random-date-generator': {
    ...
    keywords: 'random date, date picker, event planner, AI random date generator, random time',
  ...
  'random-time-generator': {
    ...
    keywords: 'random time, time picker, schedule helper, AI random time generator, random date',
  ...
  'meme-text-generator': {
    ...
    keywords: 'meme text, funny text, caption generator, viral content, AI meme text generator, meme caption',
  ...
  'meme-caption-generator': {
    ...
    keywords: 'meme caption, funny captions, internet memes, relatable humor, AI meme caption generator, meme text',
  ...
  'roast-generator': {
    ...
    keywords: 'roast, funny insults, lighthearted teasing, humor, AI roast generator, comeback, joke',
  ...
  'comeback-generator': {
    ...
    keywords: 'comeback, witty retort, clever reply, quick response, AI comeback generator, roast, joke',
  ...
  'cocktail-name-generator': {
    ...
    keywords: 'cocktail name, drink names, mixology, bar menu, AI cocktail name generator, restaurant name',
