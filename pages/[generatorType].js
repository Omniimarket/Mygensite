...
const generatorContentMap = {
  ...
  //'html-code-generator': htmlCodeGenerator, // Commented out in original
...
const GeneratorPage = ({ generatorType }) => {
  ...
  return (
    // Ensure viewport meta tag is correct in _document.js or directly here if it's not global
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col font-inter overflow-x-hidden">
      <Head>
        {/* Make sure this meta tag is present and correct in your _document.js or _app.js */}
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      ...
      {/* Added 'w-full' to ensure it takes full available width */}
      <main className="flex-grow container mx-auto px-4 py-8 overflow-x-hidden w-full">
        ...
        <section className="bg-gray-850 p-6 sm:p-8 rounded-xl shadow-lg border border-blue-700 mb-12">
          ...
          {/* Adjusted font size, maintained centering, text-left for content flow, and ADDED BREAK-ALL and MAX-W-FULL */}
          {/* Explicitly using w-full here to ensure it uses the full available width for text wrapping */}
          {/* Added 'force-list-styles' custom class to explicitly manage list item styles within prose */}
          <div className="text-gray-300 mb-8 text-left text-base leading-relaxed prose dark:prose-invert prose-blue mx-auto w-full break-all force-list-styles">
